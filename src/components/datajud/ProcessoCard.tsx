...
export default function ProcessoCard({ processo }: ProcessoCardProps) {
  const { numero, orgaoJulgador, assunto, classe, dataDistribuicao, ultimaMovimentacao } = processo;
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-gray-900 truncate" data-testid="processo-numero">
            {numero}
          </p>
          ...
          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-500">
            ...
            <span data-testid="data-distribuicao">Distribuído: {formatDate(dataDistribuicao)}</span>
          </div>
