...
|---|-------|--------|------------|--------------|
| 01 | Design tokens e componentes uiverse.io base | pending | medium | — |
| 02 | Schema de banco: tabelas multi-tenancy e migrations | pending | critical | — |
| 03 | Auth expandido: CPF, OAB, organizations, papéis e 2FA | pending | high | task_02 |
| 04 | Layout base e sidebar responsiva | pending | medium | task_01, task_03 |
| 05 | Stripe billing: checkout, webhook e middleware de acesso | pending | high | task_02, task_03 |
| 06 | Resend: setup e templates de e-mail base | pending | low | task_03 |
| 07 | Importação automática de processos via Inngest + DataJud/PJe | pending | high | task_02, task_03, task_05 |
| 08 | CRM backend: endpoints de processos, movimentações e notas | pending | high | task_02, task_03, task_07 |
...
| 19 | Stripe Customer Portal e self-service de assinatura | pending | medium | task_05 |
